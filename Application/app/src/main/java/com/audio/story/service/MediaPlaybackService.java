package com.audio.story.service;
...
import com.audio.story.engine.app.settings.SharedPreferencesCompat;
import com.audio.story.engine.widget.MediaAppWidgetProvider;
import com.audio.story.receiver.MediaButtonIntentReceiver;
import com.audio.story.engine.app.utils.AlbumUtils;
...
public class MediaPlaybackService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.audio.story.playstatechanged";
    public static final String META_CHANGED = "com.audio.story.metachanged";
    public static final String QUEUE_CHANGED = "com.audio.story.queuechanged";

    public static final String SERVICECMD = "com.audio.story.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.audio.story.musicservicecommand.togglepause";
    public static final String PAUSE_ACTION = "com.audio.story.musicservicecommand.pause";
    public static final String PREVIOUS_ACTION = "com.audio.story.musicservicecommand.previous";
    public static final String NEXT_ACTION = "com.audio.story.musicservicecommand.next";

    public static final String ACTION_STOP_SERVICE = "com.audio.story.musicservicecommand.ACTION_STOP_SERVICE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (CMDNEXT.equals(cmd) || NEXT_ACTION.equals(action)) {
                ...
                mPausedByTransientLossOfFocus = false;
                seek(0);
            }  else if (ACTION_STOP_SERVICE.equals(cmd)) {
                pause();
                mPausedByTransientLossOfFocus = false;
                seek(0);
            }
...
//            ed.apply();
    ...
    private void updateNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent("com.android.music.PLAYBACK_VIEWER")
                                                                .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK), 0);

        // Set the info for the views that show in the notification panel.
        Notification notification = new NotificationCompat.Builder(this)
            .setSmallIcon(R.drawable.app_music)  // the status icon
    ...
    private void setUpRemoteView(RemoteViews remoteView) {
        ...
        remoteView.setOnClickPendingIntent(R.id.button_close, buildPendingIntent(ACTION_STOP_SERVICE));
        remoteView.setOnClickPendingIntent(R.id.button_play_last, buildPendingIntent(PREVIOUS_ACTION));
        remoteView.setOnClickPendingIntent(R.id.button_play_next, buildPendingIntent(NEXT_ACTION));
        remoteView.setOnClickPendingIntent(R.id.button_play_toggle, buildPendingIntent(TOGGLEPAUSE_ACTION));
    }

    private void updateRemoteViews(RemoteViews remoteView) {
        if (getAudioId() < 0) {
            // streaming
            remoteView.setTextViewText(R.id.text_view_name, getPath());
            remoteView.setTextViewText(R.id.text_view_artist, null);
        } else {
            String artist = getArtistName();
            remoteView.setTextViewText(R.id.text_view_name, getTrackName());
            if (artist == null || artist.equals(MediaStore.UNKNOWN_STRING)) {
                artist = getString(R.string.unknown_artist_name);
            }
            String album = getAlbumName();
            ...
            remoteView.setTextViewText(R.id.text_view_artist,getString(R.string.notification_artist_album, artist, album));                                                             
        }
        if(!isPlaying()){
        ...
        Bitmap album = MusicUtils.getArtwork(this, getAudioId(), getAlbumId(), false);          
        if (album == null) {
            remoteView.setImageViewResource(R.id.image_view_album, R.drawable.app_music);
        } else {
